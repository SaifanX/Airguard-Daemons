...
// This action is used to run the AI call securely on the backend
// to prevent API key leakage and prompt injection.
export const askCaptain = action({
  ...
  handler: async (_ctx, args) => {
    ...
    const systemPrompt = `
      ...
      - Drone Config: ${args.droneModel} (Operating Height: ${args.droneAltitude}m)
      - ${args.weatherContext}
