...
export const askCaptain = action({
  ...
  handler: async (ctx, args) => {
    ...
    const weatherContext = args.weatherContext || "- Weather telemetry not synced";
    const zoneContext = args.zoneContext || "Primary airspace is clear of active restrictions.";
    ...
    - Drone Config: ${args.droneModel} (Operating Height: ${args.droneAltitude !== undefined ? args.droneAltitude : 'Unknown'}m)
    - ${weatherContext}
