...
const AiAssistant: React.FC = () => {
  ...
  const handleSend = async (overrideText?: string) => {
    ...
    try {
      ...
      aiResponseText = "System encountered an error communicating with tactical core.";
    }

    const aiMsg: Message = { id: (Date.now() + 1).toString(), sender: 'ai', text: aiResponseText || "No response." };
